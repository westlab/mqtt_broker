...
proc create_root_design { parentCell } {
  ...
  set CLK156M [ create_bd_port -dir O -type clk CLK156M ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {156248437} \
 ] $CLK156M
  set completion_status0 [ create_bd_port -dir I -from 4 -to 0 completion_status0 ]
  set completion_status1 [ create_bd_port -dir I -from 4 -to 0 completion_status1 ]
  set completion_status2 [ create_bd_port -dir I -from 4 -to 0 completion_status2 ]
  set completion_status3 [ create_bd_port -dir I -from 4 -to 0 completion_status3 ]
  set restart_tx_rx [ create_bd_port -dir O restart_tx_rx ]
  set sys_resetp [ create_bd_port -dir O sys_resetp ]

  # Create instance: axi32regs_0, and set properties
  set block_name axi32regs
  set block_cell_name axi32regs_0
  if { [catch {set axi32regs_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $axi32regs_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: clk_sync_0, and set properties
  set block_name clk_sync
  set block_cell_name clk_sync_0
  if { [catch {set clk_sync_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $clk_sync_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU_MIO_TREE_PERIPHERALS {Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO1 MIO#DPAUX#DPAUX#DPAUX#DPAUX#GPIO1 MIO#CAN 1#CAN 1#CAN 0#CAN 0#GPIO1 MIO#GPIO1 MIO#UART 0#UART 0#I2C 1#I2C 1#I2C 0#I2C 0#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#MDIO 3#MDIO 3} \
   CONFIG.PSU_MIO_TREE_SIGNALS {sclk_out#miso_mo1#mo2#mo3#mosi_mi0#n_ss_out#gpio0[6]#gpio0[7]#gpio0[8]#gpio0[9]#gpio0[10]#gpio0[11]#gpio0[12]#gpio0[13]#gpio0[14]#gpio0[15]#gpio0[16]#gpio0[17]#gpio0[18]#gpio0[19]#gpio0[20]#gpio0[21]#gpio0[22]#gpio0[23]#gpio0[24]#gpio0[25]#gpio1[26]#dp_aux_data_out#dp_hot_plug_detect#dp_aux_data_oe#dp_aux_data_in#gpio1[31]#phy_tx#phy_rx#phy_rx#phy_tx#gpio1[36]#gpio1[37]#rxd#txd#scl_out#sda_out#scl_out#sda_out#sdio1_wp#sdio1_cd_n#sdio1_data_out[0]#sdio1_data_out[1]#sdio1_data_out[2]#sdio1_data_out[3]#sdio1_cmd_out#sdio1_clk_out#ulpi_clk_in#ulpi_dir#ulpi_tx_data[2]#ulpi_nxt#ulpi_tx_data[0]#ulpi_tx_data[1]#ulpi_stp#ulpi_tx_data[3]#ulpi_tx_data[4]#ulpi_tx_data[5]#ulpi_tx_data[6]#ulpi_tx_data[7]#rgmii_tx_clk#rgmii_txd[0]#rgmii_txd[1]#rgmii_txd[2]#rgmii_txd[3]#rgmii_tx_ctl#rgmii_rx_clk#rgmii_rxd[0]#rgmii_rxd[1]#rgmii_rxd[2]#rgmii_rxd[3]#rgmii_rx_ctl#gem3_mdc#gem3_mdio_out} \
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M00_AXI [get_bd_intf_pins axi32regs_0/S_AXI] [get_bd_intf_pins smartconnect_0/M00_AXI]
  ...
  connect_bd_net -net axi32regs_0_Wport_restart_tx_rx [get_bd_ports restart_tx_rx] [get_bd_pins axi32regs_0/Wport_restart_tx_rx]
  connect_bd_net -net axi32regs_0_Wport_sys_resetp [get_bd_ports sys_resetp] [get_bd_pins axi32regs_0/Wport_sys_resetp]
  connect_bd_net -net clk_sync_0_Rport_completion_status0 [get_bd_pins axi32regs_0/Rport_completion_status0] [get_bd_pins clk_sync_0/Rport_completion_status0]
  connect_bd_net -net clk_sync_0_Rport_completion_status1 [get_bd_pins axi32regs_0/Rport_completion_status1] [get_bd_pins clk_sync_0/Rport_completion_status1]
  connect_bd_net -net clk_sync_0_Rport_completion_status2 [get_bd_pins axi32regs_0/Rport_completion_status2] [get_bd_pins clk_sync_0/Rport_completion_status2]
  connect_bd_net -net clk_sync_0_Rport_completion_status3 [get_bd_pins axi32regs_0/Rport_completion_status3] [get_bd_pins clk_sync_0/Rport_completion_status3]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_ports CLK100M] [get_bd_pins axi32regs_0/S_AXI_aclk] [get_bd_pins clk_sync_0/CLK] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_ports CLK156M] [get_bd_pins clk_wiz_0/clk_out2]
  connect_bd_net -net completion_status0_0_1 [get_bd_ports completion_status0] [get_bd_pins clk_sync_0/completion_status0]
  connect_bd_net -net completion_status1_0_1 [get_bd_ports completion_status1] [get_bd_pins clk_sync_0/completion_status1]
  connect_bd_net -net completion_status2_0_1 [get_bd_ports completion_status2] [get_bd_pins clk_sync_0/completion_status2]
  connect_bd_net -net completion_status3_0_1 [get_bd_ports completion_status3] [get_bd_pins clk_sync_0/completion_status3]
  connect_bd_net -net proc_sys_reset_0_interconnect_aresetn [get_bd_pins axi32regs_0/S_AXI_aresetn] [get_bd_pins proc_sys_reset_0/interconnect_aresetn] [get_bd_pins smartconnect_0/aresetn]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0xA0000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi32regs_0/S_AXI/reg0] SEG_axi32regs_0_reg0
