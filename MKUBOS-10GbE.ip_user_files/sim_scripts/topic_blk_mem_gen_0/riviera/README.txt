...
#
# Generated by export_simulation on Fri Dec 18 02:56:37 JST 2020
#
################################################################################
...
'-reset_run' switch to the './topic_blk_mem_gen_0.sh' script.

./topic_blk_mem_gen_0.sh -reset_run
...
./topic_blk_mem_gen_0.sh -noclean_files

For more information on the script, please type './topic_blk_mem_gen_0.sh -help'.
